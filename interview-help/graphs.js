...
var findJudge = function(N, trust) {
    var nodesOut = new Array(N + 1);
    var nodesIn = new Array(N + 1); 
    nodesOut.fill(0, 0, N + 1);   
    nodesIn.fill(0, 0, N + 1);
...
// other implementation with just 1 array
// instead uses add 1 and add -1
