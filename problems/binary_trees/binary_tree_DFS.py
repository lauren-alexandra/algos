"""
Problem 6: find the size (number of nodes) of a binary tree. 
...
"""
Problem 7: find the maximum value of a binary tree. 
...
"""
Problem 9: find the maximum difference between any two values in a binary tree. 
...
"""
Problem 10: find the most common value in a binary tree, also known as the mode. 
...
A vertical path is a path with at most 1 node at each height. 
